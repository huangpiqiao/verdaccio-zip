...
exports.createDestChildsDir = createDestChildsDir;
exports.getDay = getDay;
exports.getJson = getJson;
exports.isNotTgz = isNotTgz;
...
function _sourceInfo() {
  _sourceInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(sourcePath) {
    var stat, info;
...
function createDestChildsDir(sourceDir, destDir) {
  ...
  var dir = destDir;
  var childsHash = (0, _replace.default)(sourceDir, destDir, "").split(split).filter(function (hash) {
    return !!hash;
  });
  childsHash.forEach(function (hash, idx) {
    dir = (0, _path.join)(dir, "/".concat(hash).concat(idx === childsHash.length - 1 ? "/" : ""));
