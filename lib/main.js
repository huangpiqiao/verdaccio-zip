...
function _sourceInfo() {
  _sourceInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(sourcePath) {
    var stat, info;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return _promises["default"].stat(sourcePath);
          case 2:
            stat = _context6.sent;
            info = {
              mtime: stat.mtime,
...
function createDestChildsDir(sourceDir, destDir) {
  var childsHash = (0, _replace["default"])(sourceDir, destDir, "").split("/").filter(function (hash) {
    return !!hash;
  });
  childsHash.forEach(function (hash, idx) {
    var dir = destDir += "/".concat(hash).concat(idx === childsHash.length - 1 ? "/" : "");
...
var Pack2Zip = /*#__PURE__*/function () {
  function Pack2Zip(_ref) {
    ...
    this.finish = (0, _debounce["default"])(this.startCompress, 200);
  ...
  _createClass(Pack2Zip, [{
    ...
    value: function () {
      var _start = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var sourceDir, destDir, spinner, res;
    ...
    key: "clearTemp",
    value: function clearTemp(sourceDir) {
      var _this = this;
          ...
          if (stat.isDirectory()) {
            _promises["default"].readdir(sourceDir).then(function (result) {
              var mapPms = result.map(function (file) {
                return _this.clearTemp("".concat(sourceDir, "/").concat(file));
              });
              Promise.all(mapPms).then(function () {
                if (sourceDir === _this.destDir) return resolve();
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 9:
                            ...
                            return _context2.abrupt("return");
                          case 11:
                            if (!isOldFile(mtms, _this2.selectedDate)) {
                              _context2.next = 13;
                              break;
                            }
                            return _context2.abrupt("return");
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 8:
                console.log(_logSymbols["default"].success, _chalk["default"].black("\u5F53\u524D\u590D\u5236 ".concat(sourcePath)));
                this.finish();
              case 10:
              case "end":
    ...
    value: function compress() {
      ...
      this.spinner.stop();
      console.log(_logSymbols["default"].success, _chalk["default"].green("\u538B\u7F29\u5B8C\u6210 ".concat(this.zipPath)));
    }
  }]);
  return Pack2Zip;
}();
