                    ...
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            packageDir = (0, _path.join)(sourceDir, item["package"]);
                            itemName = "".concat(item["package"], "-").concat(item.version, ".tgz");
                            packagePath = (0, _path.join)(packageDir, itemName);
                            console.log(packagePath);
                            if ((0, _fs.existsSync)(packagePath)) {
                              _this.copy(packagePath, packageDir, itemName);
                            } else {
                              _utils.conso.error("\u6587\u4EF6\u672A\u4E0B\u8F7D ".concat(packagePath));
                            }
                          case 5:
                          case "end":
