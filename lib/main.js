        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 7;
              return _promises.default.copyFile(sourcePath, destPath).catch(function () {
            ...
            case 7:
              ...
              _context4.next = 11;
              return _promises.default.copyFile(packJsonFrom(sourceDir), packJsonFrom(destDir)).catch(function () {
                _utils.conso.error("\u590D\u5236\u5931\u8D25");
              });
            case 11:
              _utils.conso.success("\u590D\u5236\u6210\u529F");
    ...
    value: function shouildDownloadFile(remoteUrl, packagePath, packageDir) {
      return new Promise(function (resolve) {
        if (!(0, _fs.existsSync)(packagePath)) {
          // this.finish = null;
          _utils.conso.warn("\u6B63\u5728\u4E0B\u8F7D ".concat(packagePath));
